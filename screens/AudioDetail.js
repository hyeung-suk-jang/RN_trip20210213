    ...
    return (
        <View style={styles.container}>
            ...
            <Image
                ...
                source={{uri: 'https://imgk.timesnownews.com/story/environment-iStock-489644415.jpg?tr=w-600,h-450'}}
            />
            <View style={{ height : isAudioDetail ? '58%' : '75%', backgroundColor : COLORS.WHITE, borderTopLeftRadius: 40, borderTopRightRadius: 40,marginTop : '-10%', }}>
                    ...
                    <View>
                        ...
                        <View style={styles.saperator} />
                         ...
                         <View style={{ flexDirection : 'row' }}>
                            <View>
                                ...
                                <Text style={styles.responseText}>150,street,landmark,area,province</Text>
                            </View>
                            <TouchableOpacity
                                onPress={() => {
                                ...
                                style={{
                                    ...
                                    <EntypoIcon name="location-pin" size={35} color={COLORS.PRIMARY} />
                            </TouchableOpacity>
                        </View>
                        <View style={styles.saperator} />
                        ...
                        <View style={{ flexDirection : 'row' }}>
                            ...
                            <TouchableOpacity
                                style={{
                                    ...
                                    <FontAwesomeIcon name="phone" size={32} color={COLORS.PRIMARY} />
                            </TouchableOpacity>
                        </View>
                        <View style={styles.saperator} />
                        ...
                        <View style={{ flexDirection : 'row' }}>
                            <View>
                                ...
                                <Text style={styles.responseText}>whatever user want to keep</Text>
                            </View>
                        </View>
                        <View style={styles.saperator} />
                        ...
                        <View style={{ flexDirection : 'row' }}>
                            <View>
                                ...
                                <Text style={[styles.responseText,]}>
                                    The Style has its 2 unique radius property which is used to make only both top sides corners rounded. This type of functionality we have seen in many applications and one of the most popular social chatting platform Hike in India uses this. So in this tutorial we would going to create a react native app and set Border radius for only top left right rounded corners Image View React Native The Style has its 2 unique radius property which is used to make only both top sides corners rounded. This type of functionality we have seen in many applications and one of the most popular social chatting platform Hike in India uses this. So in this tutorial we would going to create a react native app and set Border radius for only top left right rounded corners Image View React Native
                                </Text>                            
                            </View>
                        </View>
                        <View style={[styles.saperator, { marginBottom : isAudioDetail ? 8 : 50 }]} />

                    </View>
                </ScrollView>
            </View>
            { isAudioDetail && (
                <View style={{ alignItems : 'center',flex :1,justifyContent : 'center',  flexDirection : 'row', height : '14%', backgroundColor : COLORS.PRIMARY, borderTopLeftRadius: 24, borderTopRightRadius: 24, }}>
                    <TouchableOpacity
                    ...
                    >
                        <EntypoIcon name="menu" size={20} style={{ marginLeft : 8 }}color={COLORS.WHITE} />
                    </TouchableOpacity>
                    <Text style={[styles.detailText,{ flex : 0.23, textAlign : 'center' }]}>City 1</Text>
                    <Text style={[styles.sizeText,{ flex : 0.11, textAlign : 'center' }]}>02:35</Text>
                    <TouchableOpacity
                        style={{ flex : 0.11, alignItems : 'center' }}
                    >
                    ...
                    <Text style={[styles.sizeText,{ flex : 0.11, textAlign : 'center' }]}>05:40</Text>
                </View>
            )
            }
        </View>
